            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/logo.png" alt="" style="width: 90px; object-fit: cover;">
                </a>
              </div><!-- End Logo -->
                    ...
                    session_start();
                      ...
                      if($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if(!empty($name) && !empty($username) && !empty($role) && !empty($password)) {
                          $sql = mysqli_query($conn, "INSERT INTO users(name, username, role, password) VALUES('$name', '$username', '$role', '$hashPassword')");
